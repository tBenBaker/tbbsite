...
<div class="right-column">
    <section id="currently" class="section-currently">
        ...
        The motion lab continues to develop. 3D pose pipeline in the performing arts center is up and running, with some tinkering to do to improve accuracy. Plotting the first study to do with that in the Spring, and building on the movement-enconding I developed in the "computational kinematics" paper. Speaking of... check out <a href="https://scitube.io/professor-ben-baker-how-computational-methods-can-distinguish-between-hip-hop-dance-styles/" target="_blank">this SciTube animation</a> about that paper! <br><br><br><br>
        This Fall I've been teaching another iteration of "Mind Body & Machine" -- functionalism and embodiment and AI, oh my -- and a new course called "Bodies and Power" thinking about how institutions and norms treat different bodies. In the Spring I'll teach Mind Body & Machine again, alongside Philosophy of Science and Philosophy of Dance.<br><br>
